...
const EmployeeFeed = ({
  ...
  return (
    <section className="max-w-4xl mx-auto py-10 px-4 w-full">
      {!limit && (
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(-1)}
              className="flex items-center justify-center w-9 h-9 rounded-full border border-slate-200 hover:bg-slate-100 transition"
            >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Explore posts shared by employees
              </p>
            </div>
          </div>
        </div>
                          ...
                          <>
                            <DropdownMenuSub>
                              ...
                              <DropdownMenuSubContent className="w-44">
                                <DropdownMenuItem
                                  onClick={() =>
                                    handleReportPost(post._id, "Spam")
                                  }
                                >
                                  Spam
                                </DropdownMenuItem>
                                ...
                                <DropdownMenuItem
                                  onClick={() =>
                                    handleReportPost(post._id, "Harassment")
                                  }
                                >
                                  Harassment
                                </DropdownMenuItem>

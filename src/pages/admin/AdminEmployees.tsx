...
import { Users, ChevronLeft, Search, Mail, Calendar, Shield, Building2, CheckCircle2 } from "lucide-react";
...
function AdminEmployees() {
    ...
    const filteredEmployees = employees.filter((emp) => {
        ...
        return emp.company?.name === companyFilter;
    });
                            ...
                            >
                                <div className="flex items-start justify-between mb-1">
                                    <div className="flex items-center gap-3">
                                        {employee.profilePhoto ? (
                                            <img src={employee.profilePhoto} alt={employee.name} className="w-10 h-10 rounded-full object-cover border border-gray-200" />
                                        ) : (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 py-2 border-y border-gray-50 mt-1">
                                        <div className="space-y-0.5">
                                            <p className="text-[8px] font-bold uppercase tracking-widest text-gray-400">Company</p>
                                            <div className="flex items-center gap-1.5">
